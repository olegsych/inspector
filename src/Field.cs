...
namespace Inspector
{
    ...
    public class Field : Member<FieldInfo>
    {
        ...
        internal delegate Field Selector(IScope scope, Type fieldType = null, string fieldName = null);

        internal static readonly Selector Select = (scope, fieldType, fieldName) =>
