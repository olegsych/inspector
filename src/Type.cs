namespace Inspector
{
    ...
    {
        /// <summary>
        /// Returns a new instance of type <typeparamref name="T"/> using the constructor that best matches given <paramref name="args"/>.
        /// </summary>
        public static T New(params object[] args) =>
            (T)typeof(T).New(args);

        /// <summary>
        /// Returns an uninitialized instance of type <typeparamref name="T"/>.
        /// </summary>
        /// <returns>
